        ...
        function startGame() {
            ...
            blueEnemyImg.src = "./imagem/blue_enemy.png";
            heroImg.src = "./imagem/hero.png";
            shotImg.src = "./imagem/tiro.png";
                ...
                if (enemy.visible) {
                    for (let bullet of bullets) {
                        if (bullet.visible && isColliding(bullet, enemy)) {
                            ...
                            enemy.visible = false;
                            enemyKillCount++;
                            if (enemyKillCount > highScore) {  // Atualiza o high score se necessário
                                highScore = enemyKillCount;
                            }
        ...
        function draw() {
            ...
            drawEnemies();
            drawKillCount();
            drawHighScore(); // Adicione esta linha
        }
